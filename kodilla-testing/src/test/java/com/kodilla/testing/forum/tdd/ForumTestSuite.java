...
public class ForumTestSuite {
    ...
    public void beforeEveryTest(){
        testCouter++;
        System.out.println("Preparing to execute test #" + testCouter);
    }
    ...
    public void testGetPost(){
        ...
        //When
        ForumPost retreivedPost;
        retreivedPost = forumUser.getPost(0);

        //Then
        Assert.assertEquals(thePost, retreivedPost);
    }
