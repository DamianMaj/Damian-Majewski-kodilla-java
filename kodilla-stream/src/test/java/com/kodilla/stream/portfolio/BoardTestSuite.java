...
public class BoardTestSuite {
    public Board preapareTestData(){
        ...
        Task task5 = new Task("Optimaze searching",
        ...
        //Board
        Board project = new Board("Project Wheather Prediction");
    ...
    public void testAddTaskList() {
        //Given
        Board project = preapareTestData();
        //When
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        double average = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
                .flatMap(tl -> tl.getTasks().stream())
                .map(tl -> ChronoUnit.DAYS.between(tl.getCreated(), LocalDate.now()))
                .mapToLong(tl -> tl)
                .average().getAsDouble();
        //Then
