...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriends() {
        //Given
        //Create users
        ForumUser user1 = new ForumUser("allan01", "Alan Kosovsky", "Washington");
        ForumUser user2 = new ForumUser("ethanreard", "Ethan Reard", "Miami");
        ForumUser user3 = new ForumUser("eRik", "Erik Hull", "Key West");
        ForumUser user4 = new ForumUser("booth", "Mia Booth", "Washington");
        ForumUser user5 = new ForumUser("nicole1987", "Nicole Lee", "Orlando");
        ForumUser user6 = new ForumUser("nobody", "Brian Williams", "Miami");
        ...
        Assert.assertTrue(user1.getLocationOfFriends().contains("Orlando"));
